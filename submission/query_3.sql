-- Inserting data into the table "nancyatienno21998.user_devices_cumulated"
INSERT INTO nancyatienno21998.user_devices_cumulated
...
WITH
  ...
  yesterday AS (
    SELECT
      *
    FROM
      nancyatienno21998.user_devices_cumulated
    WHERE

...
-- This query incrementally populates the user_devices_cumulated table from the web_events and devices tables.
...
SELECT 
    ...
    -- Update the dates_active array by adding today's event_date to the front of the list.
    CASE 

...
With today AS ( select
    ...
    where
        date = DATE('2023-01-07') ), date_list_int AS ( select
        user_id,
        browser_type,
    ...
    group by
        ...
        *,
        ...
        FROM_BASE('11111110000000000000000000000000',
        2) AS weekly_base,
        BIT_COUNT(history_int,
        64) as num_days_active,
        BIT_COUNT(BITWISE_AND(history_int,
        FROM_BASE('11111110000000000000000000000000',
        2)),
        64) > 0 as is_weekly_active,
        BIT_COUNT(BITWISE_AND(history_int,
        FROM_BASE('00000001111111000000000000000000',
        2)),
        64) > 0 as is_weekly_active_last_week,
        BIT_COUNT(BITWISE_AND(history_int,
        FROM_BASE('11100000000000000000000000000000',
        2)),
        64) > 0 as is_active_last_three_days 
    from
        date_list_int

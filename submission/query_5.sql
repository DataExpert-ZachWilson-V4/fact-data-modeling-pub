...
CREATE TABLE jlcharbneau.hosts_cumulated (
   ...
   partitioned_by = ARRAY['date'] -- Partitions the table by the 'date' column for better query performance on temporal data.
)